...
# Edge Impulse library for classification of fertile and infertile eggs on day 7

This is a C++ library that lets you run the impulse for "classification of fertile and infertile eggs on day 7" (https://studio.edgeimpulse.com/studio/549668) on any device. It consists of the Edge Impulse inferencing SDK - with implementations of both processing and learning blocks - and your model. You will need to include this library in your project to run your impulse locally.
